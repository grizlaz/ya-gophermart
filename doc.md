...
![Struct example](struct_reference.png "Structure")
...
- `POST /api/user/orders` — загрузка пользователем номера заказа для расчёта;+- (добавить дерганье сервиса по расчету баллов)
